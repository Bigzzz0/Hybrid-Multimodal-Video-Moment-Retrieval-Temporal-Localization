...
**ชื่อโครงงาน (ภาษาไทย):** ระบบสืบค้นและระบุตำแหน่งช่วงเวลาในวิดีโอด้วยภาษาธรรมชาติแบบไฮบริดหลายมิติโดยใช้แบบจำลองภาษาภาพขนาดใหญ่ SigLIP 2 ฐานข้อมูลเวกเตอร์แบบไร้เซิร์ฟเวอร์ และการรู้จำเสียงพูดความเร็วสูง  
**ชื่อโครงงาน (ภาษาอังกฤษ):** State-of-the-Art Hybrid Multimodal Video Moment Retrieval and Temporal Localization Using SigLIP 2, MiniCPM-V, Whisper-Turbo, and LanceDB  
