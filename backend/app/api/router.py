...
from app.api.v1 import upload, search, video, websocket, rag, system, grounding, captions
...
api_router.include_router(captions.router, prefix="/videos", tags=["Caption Artifacts"])
