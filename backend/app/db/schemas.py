...
VLM_CAPTION_ARTIFACT_SCHEMA = pa.schema([
    ...
    pa.field("json_valid", pa.bool_()),
    pa.field("fallback_used", pa.bool_()),
    pa.field("created_at", pa.string()),
    pa.field("last_accessed_at", pa.string()),
])

QWEN_VERIFICATION_V2_SCHEMA = pa.schema([
    pa.field("id", pa.string()),
    pa.field("video_id", pa.string()),
    pa.field("video_fingerprint", pa.string()),
    pa.field("normalized_query", pa.string()),
...
VLM_ARTIFACT_METADATA_SCHEMA = pa.schema([
    ...
    pa.field("active_artifact_version", pa.string()),
    pa.field("pending_artifact_version", pa.string()),
    pa.field("build_status", pa.string()),
    pa.field("fallback_count", pa.int32()),
])
...
class SearchResponse(BaseModel):
    ...
    caption_artifact_version: Optional[str] = None
    caption_fallback_used: bool = False
    online_verifier_used: bool = False
    online_verifier_model_id: Optional[str] = None
