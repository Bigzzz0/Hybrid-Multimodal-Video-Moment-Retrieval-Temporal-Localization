    ...
    {(["fast", "accurate"] as const).map((profile) => {
      ...
      return (
        <button
          ...
          title={profile === "accurate" ? "Fast + Qwen visual verification; ตรวจสูงสุด 3 ช่วง, budget ไม่เกิน 15 วินาที" : "ค้นหาเร็วจาก visual index; warm target ไม่เกิน 1 วินาที"}
        >
